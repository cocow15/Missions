...
function peopleAnimation() {
    ...
    function step() {
        ...
        people1.style.left = positionY / 2 + 'px';
        people1.style.top = -positionY / 2 + 450 + 'px';

        people2.style.right = -positionY / 2 + 500 + 'px';
        people2.style.top = -positionY / 2 + 500 + 'px';
        window.requestAnimationFrame(step);
    }
...
function shape2Animation() {
    ...
    function step() {
        ...
        shape2.style.bottom = positionY + 'px';
        window.requestAnimationFrame(step);
    }
